...
# 如果使用 PyQt6 中的屏幕信息，可替换 screeninfo；此处按原逻辑保留 screeninfo
        ...
        if self.mode == "single":
            ...
            for monitor in monitors:
                ...
                if window_urls or self.slots_per_screen > 0:
                    # 即便 window_urls 为空，只要 slots_per_screen>0 也会创建空格
